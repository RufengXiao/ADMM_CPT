...
for i = 1:period_num
    for j = 1:repeat_num
        ...
        sigma = 10;
        t1 = clock;
        [Hs,Hs2] = dynamic_programming(an,bn,wn,sigma,args);
        xopt = back_tracking(Hs,Hs2);
        t2 = clock;
...
save('./res/subproblemtest.mat','dp_val','dp_time','pav_val','pav_time','fmincon_val','fmincon_time');
